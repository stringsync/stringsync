...
func TestRouter_Get(t *testing.T) {
	t.Run("responds to GET requests", func(t *testing.T) {
		router := NewRouter()
	...
	t.Run("ignores non-GET requests", func(t *testing.T) {
		router := NewRouter()
		router.Get("/", echoHandler("ok"))
	...
	t.Run("registers deep paths", func(t *testing.T) {
		router := NewRouter()
	...
	t.Run("disallows invalid paths", func(t *testing.T) {
		defer func() {
			if r := recover(); r == nil {
...
func TestRouter_Post(t *testing.T) {
	t.Run("responds to POST requests", func(t *testing.T) {
		router := NewRouter()
	...
	t.Run("registers deep paths", func(t *testing.T) {
		router := NewRouter()
		router.Post("/foo/bar", echoHandler("ok"))

		w := httptest.NewRecorder()
		r := httptest.NewRequest(http.MethodPost, "/foo/bar", nil)
		router.ServeHTTP(w, r)
...
func TestRouter_Middleware(t *testing.T) {
	t.Run("calls middleware when processing requests", func(t *testing.T) {
		numCalls := 0
	...
	t.Run("calls each middleware", func(t *testing.T) {
		numCalls1 := 0
		numCalls2 := 0
	...
	t.Run("calls each middleware in declaration order", func(t *testing.T) {
		got := []int{}
