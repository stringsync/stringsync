import { predicate, InferableComponentEnhancer, branch, renderComponent } from 'recompose';

export type Condition<TProps> = [predicate<TProps>, InferableComponentEnhancer<TProps>];
