...
export const INFO_EMAIL: ConfigSpec<ConfigKind.STRING, false> = { kind: ConfigKind.STRING, nullable: false };
export const DEV_EMAIL: ConfigSpec<ConfigKind.STRING, true> = { kind: ConfigKind.STRING, nullable: true };
